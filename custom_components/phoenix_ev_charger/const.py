...
BINARY_SENSOR_TYPES = {
    "StatusDigInLD": ["Input LD", "statdiginld", None, "mdi:electric-switch"],
    "StatusDigInEN": ["Input EN", "statdiginen", None, "mdi:electric-switch"],
    "StatusDigInML": ["Input ML", "statdiginml", None, "mdi:electric-switch"],
    "StatusDigInXR": ["Input XR", "statdiginxr", None, "mdi:electric-switch"],
    "StatusDigInIN": ["Input IN", "statdiginin", None, "mdi:electric-switch"],
    "StatusDigOutER": ["Output ER", "statdigouter", None, "mdi:led-outline"],
    "StatusDigOutLR": ["Output LR", "statdigoutlr", None, "mdi:led-outline"],
    "StatusDigOutVR": ["Output VR", "statdigoutvr", None, "mdi:led-outline"],
    "StatusDigOutCR": ["Output CR", "statdigoutcr", None, "mdi:led-outline"],
}
